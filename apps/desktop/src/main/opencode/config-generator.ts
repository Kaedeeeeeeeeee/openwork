...
export async function generateOpenCodeConfig(): Promise<string> {
  ...
  const config: OpenCodeConfig = {
    ...
    // Note: Z.AI Coding Plan uses 'zai-coding-plan' as provider ID in OpenCode CLI
    enabled_providers: ['anthropic', 'openai', 'google', 'groq', 'deepseek', 'zai-coding-plan'],
 ...
 * This allows OpenCode CLI to recognize DeepSeek and Zhipu providers
 */
